...
<div class="card-body" style="width:500px;">
                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST" action="{{ route('register') }}">
                    ...
                    <div class="col-12">
                      ...
                      @error('sexe') is-invalid @enderror" name="sexe" value="{{ old('sexe') }}" required autocomplete="sexe">
                    ...
                    <div class="col-12">
                      ...
                      @enderror" name="tel" value="{{ old('tel') }}" required autocomplete="tel">
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" disabled placeholder='password' id="password" class="form-control 
