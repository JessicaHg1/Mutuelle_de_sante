                            ...
                            <div class="card-body">
                              ...
                              <div class="col-6">
                                      <label class="form-label">Adhérent</label>
                                        <select class="form-select" wire:model='adherent_id' aria-label="Default select example">
                                          <option selected>Choisir</option> 
                              ...
                              <div class="text-center">
                                  ...
                                  <button type="button" class="btn btn-danger" wire:click="goToBeneficiaireList">Retourner à la liste des bénéficiaires</button>
                              </div>
